...
const content_data: {
  ...
  {
    title: 'It’s take 2 minutes to open an account.',
    subtitle: 'Open Acount',
    icon: icon_1,
    link: '/sign-in'
  },
  {
    title: 'Find talents or search your desire work.',
    subtitle: 'Apply job or hire',
    icon: icon_2,
    link: '/candidates'
  },
  {
                ...
                <div className="col-xxl-5 col-xl-6 col-lg-6 ms-auto">
                  <div className="text-wrapper wow fadeInRight">
                    ...
                    <p className="text-white">
                      Get access to our top 1% talent as well as a complete set
                      of hybrid workforce management tools.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div key={i} className="col-lg-4">
                      <div className="d-flex mt-20 wow fadeInUp">
                        ...
                        <div className="ps-4 text">
                          ...
                          <Link href={c.link} className="fw-500 text-uppercase">
                            {c.subtitle}
                          </Link>
                        </div>
                      </div>
