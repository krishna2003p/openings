...
const FeedbackOne = ({
  ...
  return (
    <section
      className={`feedback-section-one ${style_3 ? 'pt-120 lg-pt-100' : 'pt-180 xl-pt-150 lg-pt-100'} ${about_p ? 'pb-80 lg-pb-20' : ''}`}
    >
      <div className="container position-relative">
        <div className="row">
          <div className="col-lg-5 col-md-6">
            <div
              ...
              data-wow-delay="0.3s"
            >
              <h2 className={style_3 ? 'main-font' : ''}>
          ...
          {feedback_data.map((item) => (
            <div key={item.id} className="item">
              ...
              >
                ...
                <blockquote
                  className={`fw-500 mt-50 md-mt-30 mb-50 md-mb-30 ${style_2 ? 'text-white' : ''}`}
                >
                  {item.title}
                </blockquote>
                ...
                <div className="review pt-40 md-pt-20 mt-40 md-mt-30 d-flex justify-content-between align-items-center">
                  <div
                    className={`text-md fw-500 ${style_2 ? 'text-white' : 'text-dark'}`}
                  >
        ...
        {!style_2 && (
          <div
            className={`partner-logos ${about_p ? 'border-0' : ''} pt-150 xl-pt-120 md-pt-80 sm-pt-40 pb-80 md-pb-40`}
          >
